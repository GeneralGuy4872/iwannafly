bone *sculpt_human()
  ...
  struct bone *lfinger5 = finger(larm,lfinger4,3,{0,0,xLEFT(22.5)},COS_PI_16)
    ...
    *rshoulder = {index_spine,lfinger5,NULL,{FR_ZERO,FR_ZERO,FR_ZERO},{mfrfl(geomet[6]),0,0},matgen_z_deg(xRIGHT(90)),matgen_ident,TRUE,NULL}
  ...
  struct bone *lleg = leg(pelvis,rfinger5,mfrfl(geomet[9]),xLEFT(mfrfl(geomet[14])),LEFT)
  ...
  struct bone *rleg = leg(pelvis,ltoe5,mfrfl(geomet[9]),xRIGHT(mfrfl(geomet[14])),RIGHT)
