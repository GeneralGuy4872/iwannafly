bone *sculpt_insectoid()
  ...
  *center = (foo->root,NULL,NULL,(0,0,0),(.1,.346,.125),matgen_ident,matgen_ident,FALSE,*pelvis,4)
  ...
  bone *rshoulder = (*cervical,*lfinger2,NULL,(0,0,0),(.198,0,0),matgen_z_deg(90),matgen_ident,TRUE,NULL,0)
  ...
  bone *lankle = digiti(*rfinger2,*center,.48,(-15,15),LEFT)
  bone *ltoe2 = talonphalanges(*lankle,*lankle,3,(0,0,30),COS_PI_8)
  bone *ltoe3 = talonphalanges(*ltoe2,*lankle,3,(0,0,-30),COS_PI_8)
  bone *ltoe4 = talonphalanges(*ltoe3,*lankle,3,(0,0,-150),COS_PI_8)
  bone *ltoe1 = talonphalanges(*ltoe4,*lankle,2,(0,0,150),COS_PI_8)
  bone *rankle = digiti(*ltoe1,*center,.48,(15,15),RIGHT)
  bone *rtoe2 = talonphalanges(*rankle,*rankle,3,(0,0,-30),COS_PI_8)
  bone *rtoe3 = talonphalanges(*rtoe2,*rankle,3,(0,0,30),COS_PI_8)
  bone *rtoe4 = talonphalanges(*rtoe3,*rankle,3,(0,0,150),COS_PI_8)
  bone *rtoe1 = talonphalanges(*rtoe4,*rankle,2,(0,0,-150),COS_PI_8)
  bone *lwing1 = (*cervical->prev->prev->prev->prev->prev,*rtoe1,NULL,(0,0,1),(0,0,1),matgen_x_deg(-60),matgen_ident,TRUE,NULL,0) //.up = vert[(nmax-1)-5]
  doublelink(*lwing1)
  bone *lwing2 = (*cervical->prev->prev->prev->prev->prev,*lwing1,NULL,(0,0,1),(0,0,1),matgen_x_deg(-120),matgen_ident,TRUE,NULL,0) //.up = vert[(nmax-1)-5]
  doublelink(*lwing1)
  bone *rwing1 = (*cervical->prev->prev->prev->prev->prev,*lwing2,NULL,(0,0,1),(0,0,1),matgen_x_deg(60),matgen_ident,TRUE,NULL,0) //.up = vert[(nmax-1)-5]
  doublelink(*lwing1)
  bone *rwing2 = (*cervical->prev->prev->prev->prev->prev,*rwing1,NULL,(0,0,1),(0,0,1),matgen_x_deg(120),matgen_ident,TRUE,NULL,0) //.up = vert[(nmax-1)-5]
  doublelink(*lwing1)
  polygon stinger[8] = bone_bicone(.66,-.173)
  bone *tail = (*center,*tail,NULL,(1,0,0),(.173,.346,.346),matgen_y_deg(45),matgen_ident,TRUE,*stinger,8)
  doublelink(tail)
  return *center
  }
