...
#define shape_line(X,Y,Z) {&i_line,num_line,v_line(X,Y,Z)}
...
#define shape_wire_triangle(H,W) {&i_wire_triangle,num_triangle,v_triangle(H,W)}
#define shape_poly_triangle(H,W) {&i_poly_triangle,num_triangle,v_triangle(H,W)}
...
#define shape_wire_octo(R) {&i_wire_octo,num_wire_octo,v_octo(R)}
#define shape_poly_octo(R) {&i_poly_octo,num_poly_octo,v_octo(R)}
#define shape_wire_bicone(L,R) {&i_wire_bicone,num_wire_bicone,v_bicone(L,R)}
#define shape_poly_bicone(L,R) {&i_poly_bicone,num_poly_bicone,v_bicone(L,R)}
...
#define shape_wire_cube(X,Y,Z) {&i_wire_cube,num_wire_cube,v_cube(X,Y,Z)}
#define shape_poly_cube(X,Y,Z) {&i_poly_cube,num_poly_cube,v_cube(X,Y,Z)}
...
#define shape_wire_pyra(R,H) {&i_wire_pyra,num_wire_pyra,v_pyra(X,Y,Z)}
#define shape_poly_pyra(R,H) {&i_poly_pyra,num_poly_pyra,v_pyra(X,Y,Z)}
...
#define shape_wire_xfan(L,R,D) {&i_wire_fan,num_wire_fan,v_xfan(L,R,D)}
#define shape_poly_xfan(L,R,D) {&i_poly_fan,num_poly_fan,v_xfan(L,R,D)}
#define shape_wire_zfan(L,R,D) {&i_wire_fan,num_wire_fan,v_zfan(L,R,D)}
#define shape_poly_zfan(L,R,D) {&i_poly_fan,num_poly_fan,v_zfan(L,R,D)}
