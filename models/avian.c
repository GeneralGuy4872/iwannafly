...
*entity summon_avian(xcoord,ycoord,zcoord,geomet,yinv)
	...
	struct entity *tmp = {WORLD.ent_tail,NULL,{xcoord,ycoord,zcoord,MAP.dots[xcoord][ycoord] * 5},{geomet[mes_hbr],geomet[mes_hbh],geomet[mes_hboff]),geomet[mes_hbeyes])},{0,0,0},{0,0,0},matgen_ident,{FALSE,FALSE,FALSE,TRUE,TRUE,FALSE,FALSE,FALSE},{TRUE,TRUE,TRUE,TRUE,FALSE,FALSE,TRUE,FALSE},{6,-4},255,AVE_FRIC,AVE_MASS,AVE_DENSE,&AVE_DRAG,&AVE_SPD,sculpt_avian(geomet)}
	}
